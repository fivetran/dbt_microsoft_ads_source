...
final as (
    ...
    select
        ...
        {{ microsoft_ads_fill_pass_through_columns(pass_through_fields=var('microsoft_ads__ad_passthrough_metrics'), except=['conversions_qualified', 'conversions', 'revenue', 'all_conversions_qualified', 'all_conversions', 'all_revenue']) }}
